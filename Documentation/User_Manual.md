...
## Dashboard Page
 ...
 On the right side of the page there are two buttons. The graph button will take you to a graph page. The minus button will remove the item from the dashboard page. The lightbulb button will take you to the machine learning page.

## Graph Page
 The item that you clicked will display a bar graph of various price points for that item.

## Machine Learning Page
 Click the "get all data button", and you will see data about the machine learning algorithm display on the screen, as well as seeing the predicted price for tomorrow.