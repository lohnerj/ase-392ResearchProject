...
### Machine Learning Page
 Display the information that went into the algorithm, and display the predicted price of tomorrows object, as well as the difference between the predicted price.